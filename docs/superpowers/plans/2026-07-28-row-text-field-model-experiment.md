...
- [ ] **Step 3: Implement the closed BIO codec without creating a second field vocabulary.**
  ...
  ```python
  def complete_exact_row_event(gold: GoldRow, prediction: RowPrediction) -> bool:
      report = score_predictions((gold,), (prediction,))
