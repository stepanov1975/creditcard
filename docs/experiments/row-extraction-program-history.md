# Historical program-status snapshot

> Read-only history copied from merchant-gold-seed at commit
> `6c500cc11d8abef809527e491605b322b9c34cf6` on 2026-09-20.
> The original text below is preserved verbatim, including its former live-status
> wording. Only [the live status](row-extraction-program-status.md) determines
> the current phase. Historical recommendations and approvals are not new work.
...
Authority was committed at `309da14` before preparation. The local worksheet
contains six blank final decisions and both prior human readings/region sets
